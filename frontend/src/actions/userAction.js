...
export const loadUser = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${baseurl}/auth/me`, { credentials: 'include', withCredentials: true });
        console.log(data)
...
export const logoutUser = () => async (dispatch) => {
    try {
        await axios.post(`${baseurl}/auth/logout`, {}, { withCredentials: true }); // Correctly place 'withCredentials'
