...
export const getProducts =
    (keyword = "", category, price = [0, 200000], ratings = 0, currentPage = 1) => async (dispatch) => {
        try {
            ...
            params.append("priceGte", price[0]);
            params.append("priceLte", price[1]);
            params.append("ratingsGte", ratings);
            params.append("page", currentPage);

            // Conditionally add the category
            if (category) {
...
export const getProductDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${baseurl}/products/${id}`, { credentials: 'include', withCredentials: true });
...
// Example of personalized or category-based fetch
...
export const getSliderProducts = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${baseurl}/products/all`, { credentials: 'include', withCredentials: true });
        dispatch({
